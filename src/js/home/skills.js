  ...
  <div className="skills">
    <div className="skills__item">
      ...
      <p className="skills__text">
        I use the most modern and advanced tools to make sure your website is
        fast and responsive.
      </p>
    ...
    <div className="skills__item">
      ...
      <p className="skills__text">
        You found someone who cares about the way your application looks and
        feels.
      </p>
      <button className="btn skills__btn">Tell me more &rarr; </button>
    </div>
    ...
    <div className="skills__item">
      ...
      <p className="skills__text">
        I create custom microsoft apllications for tracking progress, employees,
        or supplys.
      </p>
      <button className="btn skills__btn">Tell me more &rarr; </button>
    </div>
    ...
    <div className="skills__item">
      ...
      <p className="skills__text">
        Dont waste time on repetitive tasks. I'll develope solutions to save
        your company time.
      </p>
      <button className="btn skills__btn">Tell me more &rarr; </button>
    </div>
